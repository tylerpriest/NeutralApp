import { IPluginManager, IPluginAPI, IPluginSandbox } from '../../src/interfaces/plugin.interface';
import { PluginInfo, PluginPackage, InstallResult, PluginStatus } from '../../src/types';
