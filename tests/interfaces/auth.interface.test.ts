import { IAuthenticationService, ISessionManager } from '../../src/interfaces/auth.interface';
import { AuthResult, ValidationResult, User, Session, UserProfile } from '../../src/types';
