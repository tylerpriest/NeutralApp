import { WidgetRegistry, IWidgetRegistry } from '../services/widget.registry';
import { Widget, WidgetStatus, WidgetConfig, ComponentSize, ComponentPosition } from '../../../shared/types';
